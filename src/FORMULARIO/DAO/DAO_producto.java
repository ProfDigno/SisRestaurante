...
public class DAO_producto {
    ...
    private String sql_insert = "INSERT INTO public.producto(\n"
            ...
            + "            fk_idproducto_unidad,fk_idproducto_grupo,fk_idproducto_cuenta,iva)\n"
            + "    VALUES (?, ?, ?, ?, ?, ?, \n"
            + "            ?, ?, ?, ?, ?, ?, \n"
            + "            ?, ?,?,?);";
    private String sql_update = "UPDATE public.producto\n"
            ...
            + "       fk_idproducto_categoria=?, fk_idproducto_unidad=?,fk_idproducto_grupo=?,fk_idproducto_cuenta=?,iva=? \n"
            + " WHERE idproducto=?;";
...
//        int id = evejt.getInt_select_id(tabla);
        ...
        try {
            ...
            if (rs.next()) {
                ...
                prod.setP15fk_idproducto_cuenta(rs.getInt(17));
                prod.setP16iva(rs.getInt(18));
            }
        } catch (Exception e) {
    ...
    public void insertar_producto(Connection conn, producto prod) {
        ...
        try {
            ...
            pst.setInt(15, prod.getP15fk_idproducto_cuenta());
            pst.setInt(16, prod.getP16iva());
            pst.execute();
            pst.close();
...
//            pst.setInt(16, prod.getP16iva());
    ...
    public void update_producto(Connection conn, producto prod) {
        ...
        try {
            ...
            pst.setInt(13, prod.getP14fk_idproducto_grupo());
            pst.setInt(14, prod.getP15fk_idproducto_cuenta());
            pst.setInt(15, prod.getP16iva());
            pst.setInt(16, prod.getP1idproducto());
            pst.execute();
            pst.close();
    ...
    public void buscar_tabla_producto(Connection conn, JTable tbltabla, JTextField txtbuscar, int tipo) {
        ...
        String sql = "SELECT p.idproducto,(pc.nombre||'-'||pu.nombre||'-'||p.nombre) as nombre, "
                ...
                + "  where p.fk_idproducto_categoria=pc.idproducto_categoria\n"
                + "  and p.fk_idproducto_unidad=pu.idproducto_unidad\n" + filtro
                + "  order by pc.nombre,p.nombre asc ";
