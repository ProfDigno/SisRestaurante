...
public class usuario {
    ...
    */
    ...
    public int getU6fk_idcajero() {
        return u6fk_idcajero;
    }

    public void setU6fk_idcajero(int u6fk_idcajero) {
        this.u6fk_idcajero = u6fk_idcajero;
    }

    public static int getGlobal_idcajero() {
        return global_idcajero;
    }

    public static void setGlobal_idcajero(int global_idcajero) {
        usuario.global_idcajero = global_idcajero;
    }
