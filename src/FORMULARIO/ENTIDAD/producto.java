...
public class producto {
    ...
    private int p16iva;
    private int p15fk_idproducto_cuenta;
    ...
    public int getP16iva() {
        return p16iva;
    }

    public void setP16iva(int p16iva) {
        this.p16iva = p16iva;
    }

    public int getP15fk_idproducto_cuenta() {
        return p15fk_idproducto_cuenta;
    }

    public void setP15fk_idproducto_cuenta(int p15fk_idproducto_cuenta) {
        this.p15fk_idproducto_cuenta = p15fk_idproducto_cuenta;
    }
