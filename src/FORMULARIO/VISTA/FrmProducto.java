...
public class FrmProducto extends javax.swing.JInternalFrame {
    ...
    private producto_categoria ENTpca = new producto_categoria();
    private producto_unidad ENTpun = new producto_unidad();
    ...
    private boolean hab_cargar_pro_cuenta;
    private int fk_idproducto_cuenta;
    private boolean hab_cargar_pro_categoria;
    private int fk_idproducto_categoria;
    private boolean hab_cargar_pro_unidad;
    private int fk_idproducto_unidad;
    ...
    void abrir_formulario() {
        ...
        reestableser();
        DAOpro.actualizar_tabla_producto(conn, tblproducto);
    ...
    private void cargar_combobox() {
        evecmb.cargarCombobox(conn, cmbpro_cuenta, ENTpcu.getId_idproducto_cuenta(),ENTpcu.getNom_nomtabla(),ENTpcu.getTb_producto_cuenta(), " where activo=true ");
        evecmb.cargarCombobox(conn, jCpro_categoria, ENTpca.getIdtabla(),ENTpca.getNombretabla(),ENTpca.getTabla(), " where activar=true ");
        evecmb.cargarCombobox(conn, jCpro_unidad, ENTpun.getIdtabla(),ENTpun.getNombretabla(),ENTpun.getTabla(), " ");
        hab_cargar_pro_cuenta = true;
        hab_cargar_pro_categoria = true;
        hab_cargar_pro_unidad = true;
    }
    ...
    boolean validar_guardar() {
        ...
        if (evecmb.getBoo_JCombobox_seleccionar(cmbpro_cuenta, "SELECCIONE UNA CUENTA")) {
            return false;
        }
        if (evecmb.getBoo_JCombobox_seleccionar(jCpro_categoria, "SELECCIONE UNA CATEGORIA")) {
            return false;
        }
        if (evecmb.getBoo_JCombobox_seleccionar(jCpro_unidad, "SELECCIONE UNA UNIDAD")) {
            return false;
        }
        if(fk_idproducto_categoria==0){
            JOptionPane.showMessageDialog(null,"NO SE SELECCIONO CORRECTAMENTE LA CATEGORIA");
            return false;
        }
        if(fk_idproducto_cuenta==0){
            JOptionPane.showMessageDialog(null,"NO SE SELECCIONO CORRECTAMENTE LA CUENTA");
            return false;
        }
        if(fk_idproducto_unidad==0){
            JOptionPane.showMessageDialog(null,"NO SE SELECCIONO CORRECTAMENTE LA UNIDAD");
            return false;
        }
        return true;
    }
    ...
    private void cargar_dato_producto() {
        ENTpro.setP2nombre(p2_txtnombre.getText());
        ENTpro.setP3precio_venta(evejtf.getDouble_format_nro_entero1(p3_txtprecio_venta));
        ENTpro.setP4precio_compra(evejtf.getDouble_format_nro_entero1(p4_txtprecio_compra));
        ENTpro.setP5stock(Double.parseDouble(p5_txtstock.getText()));
        ENTpro.setP6orden(0);
        ENTpro.setP7activar(p7_jCactivar.isSelected());
        ENTpro.setP8cocina(p8_jCcocina.isSelected());
        ENTpro.setP9descontar_stock(p9_jCdescontar_stock.isSelected());
        ENTpro.setP10comprar(p10_jCcompra.isSelected());
        ENTpro.setP11vender(p11_jCvender.isSelected());
    ...
    void boton_guardar() {
        if (validar_guardar()) {
            ...
            BOpro.insertar_producto(ENTpro, tblproducto);
            reestableser();
        }
    }
    ...
    void boton_editar() {
        if (validar_guardar()) {
            ENTpro.setP1idproducto(Integer.parseInt(p1_txtid.getText()));
            cargar_dato_producto();
            BOpro.update_producto(ENTpro, tblproducto);
        }
    }
private int valor_iva(){
    ...
    void seleccionar_tabla() {
        ...
        DAOpro.cargar_producto(ENTpro, idproducto);
        p1_txtid.setText(String.valueOf(ENTpro.getP1idproducto()));
        iiprod.setFk_idproducto(ENTpro.getP1idproducto());
        p2_txtnombre.setText(ENTpro.getP2nombre());
        p3_txtprecio_venta.setText(evejtf.getString_format_nro_decimal(ENTpro.getP3precio_venta()));
        p4_txtprecio_compra.setText(evejtf.getString_format_nro_decimal(ENTpro.getP4precio_compra()));
        p5_txtstock.setText(evejtf.getString_format_nro_entero(ENTpro.getP5stock()));
        p7_jCactivar.setSelected(ENTpro.isP7activar());
        p8_jCcocina.setSelected(ENTpro.isP8cocina());
        p9_jCdescontar_stock.setSelected(ENTpro.isP9descontar_stock());
        p10_jCcompra.setSelected(ENTpro.isP10comprar());
        p11_jCvender.setSelected(ENTpro.isP11vender());
        fk_idproducto_categoria=ENTpro.getP12fk_idproducto_categoria();
        fk_idproducto_unidad=ENTpro.getP13fk_idproducto_unidad();
        fk_idproducto_cuenta=ENTpro.getP15fk_idproducto_cuenta();
        System.out.println("fk_idproducto_cuenta:"+fk_idproducto_cuenta);
        evecmb.setSeleccionarCombobox(conn, cmbpro_cuenta, ENTpcu.getId_idproducto_cuenta(),ENTpcu.getNom_nomtabla(),ENTpcu.getTb_producto_cuenta(),fk_idproducto_cuenta);
        evecmb.setSeleccionarCombobox(conn, jCpro_categoria,  ENTpca.getIdtabla(),ENTpca.getNombretabla(),ENTpca.getTabla(), fk_idproducto_categoria);
        evecmb.setSeleccionarCombobox(conn,  jCpro_unidad,ENTpun.getIdtabla(),ENTpun.getNombretabla(),ENTpun.getTabla(), fk_idproducto_unidad);
        txtnombre_producto_venta.setText(ENTpro.getP12categoria() + "-" + ENTpro.getP2nombre() + "-" + ENTpro.getP13unidad());
        setiva(ENTpro.getP16iva());
        ...
        iipDAO.actualizar_tabla_insumo_item_producto(conn, tblinsumo_item_producto, ENTpro.getP1idproducto());
        btnguardar.setEnabled(false);
        btneditar.setEnabled(true);
    }

    void producto_sin_ingrediente() {
        double precio_compra_insumo = ENTpro.getP4precio_compra();
        jFprecio_venta_prod.setValue(ENTpro.getP3precio_venta());
        jFprecio_compra_prod.setValue(precio_compra_insumo);
        jFprecio_ganancia.setValue(ENTpro.getP3precio_venta() - precio_compra_insumo);
        jFutilidad_ganancia.setValue(((ENTpro.getP3precio_venta() - precio_compra_insumo) / ENTpro.getP3precio_venta()) * 100);
        crear_grafico_precio_insumo();
    }

    void actualizar_compra_ganacia() {
        double precio_compra_insumo = iipDAO.suma_precio_insumo(conn, ENTpro.getP1idproducto());
        jFprecio_venta_prod.setValue(ENTpro.getP3precio_venta());
        jFprecio_compra_prod.setValue(precio_compra_insumo);
        jFprecio_ganancia.setValue(ENTpro.getP3precio_venta() - precio_compra_insumo);
        jFutilidad_ganancia.setValue(((ENTpro.getP3precio_venta() - precio_compra_insumo) / ENTpro.getP3precio_venta()) * 100);
        ENTpro.setP4precio_compra(precio_compra_insumo);
        BOpro.update_producto_pre_compra(ENTpro);
        crear_grafico_precio_insumo();
    }
    ...
    void reestableser() {
        ...
        cmbpro_cuenta.setSelectedIndex(0);
        jCpro_categoria.setSelectedIndex(0);
        jCpro_unidad.setSelectedIndex(0);
    ...
    void cargar_id_ingrediente() {
        ...
        if (validar_ingrediente()) {
            ipingre.setFk_idproducto(ENTpro.getP1idproducto());
    ...
    void boton_cargar_insumo() {
        if (validar_carga_insumo()) {
            ...
            actualizar_compra_ganacia();
            limpiar_insumo();
            DAOpro.buscar_tabla_producto(conn, tblproducto, txtbuscar_categoria, 1);
        }
    }

    void crear_grafico_precio_insumo() {
        DefaultPieDataset dataset = new DefaultPieDataset();
        dataset = evedata.createDataset_precio_insumo(conn, ENTpro.getP1idproducto());
    ...
    private void initComponents() {
        ...
        cmbpro_cuenta = new javax.swing.JComboBox<>();
        jLabel6 = new javax.swing.JLabel();
        jCpro_categoria = new javax.swing.JComboBox<>();
        btnnuevo_categoria = new javax.swing.JButton();
        jLabel7 = new javax.swing.JLabel();
        jCpro_unidad = new javax.swing.JComboBox<>();
        btnnuevo_unidad = new javax.swing.JButton();
        btnnuevo = new javax.swing.JButton();
        btnguardar = new javax.swing.JButton();
        btneditar = new javax.swing.JButton();
        btndeletar = new javax.swing.JButton();
        btnnuevo_cuenta = new javax.swing.JButton();
        ...
        p7_jCactivar.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        p7_jCactivar.setText("ACTIVAR (MOSTRAR)");

        p8_jCcocina.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        p8_jCcocina.setText("PREPARAR EN COCINA");

        p9_jCdescontar_stock.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        p9_jCdescontar_stock.setText("DESCONTAR STOCK");

        p10_jCcompra.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        p10_jCcompra.setText("SE PUEDE COMPRAR");

        p11_jCvender.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        cmbpro_cuenta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cmbpro_cuenta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbpro_cuentaActionPerformed(evt);
            }
        });

        jLabel6.setText("CATEGORIA:");

        jCpro_categoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jCpro_categoria.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCpro_categoriaActionPerformed(evt);
            }
        });
        ...
        jCpro_unidad.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jCpro_unidad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCpro_unidadActionPerformed(evt);
            }
        });
        ...
        btnnuevo_cuenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/ABM/mini_nuevo.png"))); // NOI18N
        btnnuevo_cuenta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnnuevo_cuentaActionPerformed(evt);
            }
        });
        ...
        panel_insertar_productoLayout.setHorizontalGroup(
            ...
            .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panel_insertar_productoLayout.createSequentialGroup()
                        .addGap(10, 10, 10)
            ...
            .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jRgrupo_0, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                        .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jCpro_unidad, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jCpro_categoria, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cmbpro_cuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                                        .addGap(7, 7, 7)
                                        .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(btnnuevo_unidad, javax.swing.GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE)
                                            .addComponent(btnnuevo_categoria, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                    .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(btnnuevo_cuenta, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                            .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                                .addComponent(jRgrupo_1, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap())))
        );
        panel_insertar_productoLayout.setVerticalGroup(
            ...
            .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                ...
                .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panel_insertar_productoLayout.createSequentialGroup()
                        ...
                        .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cmbpro_cuenta, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(btnnuevo_cuenta))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel6, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jCpro_categoria, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnnuevo_categoria, javax.swing.GroupLayout.Alignment.TRAILING))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel7, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jCpro_unidad, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnnuevo_unidad, javax.swing.GroupLayout.Alignment.TRAILING))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_insertar_productoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jRgrupo_0)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jRgrupo_1)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        panel_base_2Layout.setHorizontalGroup(
            ...
            .addGroup(panel_base_2Layout.createSequentialGroup()
                .addGroup(panel_base_2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panel_insertar_insumo, javax.swing.GroupLayout.PREFERRED_SIZE, 457, Short.MAX_VALUE)
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOpro.ancho_tabla_producto(tblproducto);
...
//        evejtf.saltar_campo_enter(evt, p5_txtstock, p12_txtcategoria);
    ...
    private void txtbuscar_unidadKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscar_unidadKeyReleased
        // TODO add your handling code here:
        DAOpro.buscar_tabla_producto(conn, tblproducto, txtbuscar_unidad, 2);
    ...
    private void txtbuscar_nombreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscar_nombreKeyReleased
        // TODO add your handling code here:
        DAOpro.buscar_tabla_producto(conn, tblproducto, txtbuscar_nombre, 3);
...
//        evejtf.getDouble_format_nro_entero(p4_txtprecio_compra);
    ...
    private void cmbpro_cuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbpro_cuentaActionPerformed
        // TODO add your handling code here:
        if (hab_cargar_pro_cuenta) {
            fk_idproducto_cuenta = evecmb.getInt_seleccionar_COMBOBOX(conn, cmbpro_cuenta, ENTpcu.getId_idproducto_cuenta(),ENTpcu.getNom_nomtabla(),ENTpcu.getTb_producto_cuenta());
        }
    }//GEN-LAST:event_cmbpro_cuentaActionPerformed

    private void jCpro_categoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCpro_categoriaActionPerformed
        // TODO add your handling code here:
        if (hab_cargar_pro_categoria) {
            fk_idproducto_categoria = evecmb.getInt_seleccionar_COMBOBOX(conn, jCpro_categoria, ENTpca.getIdtabla(),ENTpca.getNombretabla(),ENTpca.getTabla());
        }
    }//GEN-LAST:event_jCpro_categoriaActionPerformed

    private void jCpro_unidadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCpro_unidadActionPerformed
        // TODO add your handling code here:
        if (hab_cargar_pro_unidad) {
            fk_idproducto_unidad = evecmb.getInt_seleccionar_COMBOBOX(conn, jCpro_unidad, ENTpun.getIdtabla(),ENTpun.getNombretabla(),ENTpun.getTabla());
            System.out.println("fk_idproducto_unidad:"+fk_idproducto_unidad);
        }
    }//GEN-LAST:event_jCpro_unidadActionPerformed

    private void btnnuevo_cuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevo_cuentaActionPerformed
        // TODO add your handling code here:
        eveJfra.abrir_TablaJinternal(new FrmProducto_cuenta());
    }//GEN-LAST:event_btnnuevo_cuentaActionPerformed
    ...
    private javax.swing.JButton btnnuevo_cuenta;
    ...
    private javax.swing.JComboBox<String> cmbpro_cuenta;
    private javax.swing.ButtonGroup gru_iva;
    private javax.swing.JComboBox<String> jCpro_categoria;
    private javax.swing.JComboBox<String> jCpro_unidad;
