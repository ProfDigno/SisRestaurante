...
//            actualizar_caja_detalle_otros(fecha_emision, "VENTA_TARJETA", "c.monto_venta_tarjeta", tblcaja_venta_tarjeta,txtcantidad_venta_tarjeta,jFtotal_venta_tarjeta);
            actualizar_caja_detalle_ventas(fecha_emision, tblcaja_venta_efectivo, txtcantidad_venta_efectivo, jFtotal_venta_efectivo, jFtotal_venta_tarjeta);
    ...
    void actualizar_caja_detalle_otros(String fecha_emision, String origen_tabla, String campo_total, JTable tabla,JTextField txtcantidad,JFormattedTextField jftotal) {
        String sql = "select c.id_origen,to_char(c.fecha_emision,'yyyy-MM-dd HH24:MI') as fecha_emision,c.descripcion,"
                + "TRIM(to_char("+campo_total+",'999G999G999')) as monto,"
...
//                + "and (c.tabla_origen='VENTA_EFECTIVO' or c.tabla_origen='VENTA_TARJETA'  or c.tabla_origen='VENTA_COMBINADO') \n"
    ...
    void caja_detalle_cantidad_total_venta(String fecha_emision,JTextField txtcantidad,JFormattedTextField jftotalefectivo, JFormattedTextField jftotaltarjeta) {
        String titulo="caja_detalle_cantidad_total";
    ...
    private void initComponents() {
        ...
        panel_ventaLayout.setHorizontalGroup(
            ...
            .addGroup(panel_ventaLayout.createSequentialGroup()
                .addComponent(btnimprimir_venta, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jFtotal_venta_efectivo, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jFtotal_venta_tarjeta, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
