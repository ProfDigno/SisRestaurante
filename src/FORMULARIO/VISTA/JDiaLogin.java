...
//    Connection connser = conPsSER.getConnPosgres();
    ...
    private void habilitar_menu(boolean blo, boolean blo2) {
        ...
        FrmMenuRestaurante.btncliente.setEnabled(blo2);
        FrmMenuRestaurante.btngasto.setEnabled(blo2);
        FrmMenuRestaurante.btnproducto.setEnabled(blo);
        FrmMenuRestaurante.btnvale.setEnabled(blo2);
        FrmMenuRestaurante.btnventa.setEnabled(blo2);
        FrmMenuRestaurante.btncomanda.setEnabled(blo2);
        FrmMenuRestaurante.btncategoria.setEnabled(blo);
        FrmMenuRestaurante.btnbalance.setEnabled(blo);
        FrmMenuRestaurante.btncambiar_usuario.setEnabled(blo2);
        FrmMenuRestaurante.btncomprainsumo.setEnabled(blo2);
        FrmMenuRestaurante.jMenu_compra.setEnabled(blo);
        FrmMenuRestaurante.btncotizacion.setEnabled(blo2);
    ...
    void buscar_usuario() {
        if (pdao.getBoolean_buscar_usuario_existente(conn, usu)) {
            ...
            FrmMenuRestaurante.lblusuario.setText(usu.getGlobal_nombre());
