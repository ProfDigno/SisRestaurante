...
public class FrmFactura extends javax.swing.JInternalFrame {
    ...
    private void cambiar_ruc_cliente() {
        ...
        String ruc_nuevo = JOptionPane.showInputDialog(this, "DESEA CAMBIAR EL RUC DEL CLIENTE:\n"
                + "CLIENTE: " + clie.getC3nombre() + "\n"
                + "DIRECCION: " + clie.getC4direccion() + "\n"
                + "RUC ACTUAL: " + clie.getC6ruc() + "\n"
                + "CARGAR EL NUEVO RUC DEL CLIENTE");
        if (ruc_nuevo.equals("")) {
            JOptionPane.showMessageDialog(this, "SE DEBE CARGAR EL RUC PARA CAMBIAR");
        } else {
            clie.setC6ruc(ruc_nuevo);
            cdao.update_cliente(conn, clie,true);
    ...
    private void cambiar_direccion_cliente() {
        ...
        if (direccion_nuevo.equals("")) {
            ...
            clie.setC4direccion(direccion_nuevo);
            cdao.update_cliente(conn, clie,true);
            cargar_cliente(fk_idcliente);
        }
    }
...
//                }
    ...
    void ultimo_idfactura() {
        ...
        int nro_factura = eveconn.getInt_ultimoID_mas_uno(conn, fac.getTabla(), "nro_factura");
        txtidfactura.setText(String.valueOf(idfactura));
        txtnro_factura.setText(String.valueOf(nro_factura));
    }
    ...
    private void initComponents() {
        ...
        jLayeredPane1.add(jList_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 520, 110));
        ...
        jLayeredPane1.add(txtbucarCliente_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, 330, -1));
        ...
        jLayeredPane1.add(txtbucarCliente_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 10, 120, -1));
        ...
        jLayeredPane1.add(btncambiar_ruc, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 10, 150, -1));
        ...
        jLayeredPane1.add(btncambiar_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 40, 150, -1));
        ...
        jLayeredPane1.add(btncambiar_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 70, 150, -1));
