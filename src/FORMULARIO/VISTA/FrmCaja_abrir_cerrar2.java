...
//    ConnPostgres_SER conPsSER = new ConnPostgres_SER();
    ...
    void seleccionar_caja_detalle() {
        if (!evejt.getBoolean_validar_select(tblcaja_resumen)) {
            ...
            actualizar_caja_detalle_venta(fk_idcaja_cierre, tblcaja_venta_efectivo, txtcantidad_venta_efectivo, jFtotal_venta_efectivo, jFtotal_venta_tarjeta);
    ...
    void actualizar_caja_detalle_venta(String fk_idcaja_cierre, JTable tabla, JTextField txtcantidad, JFormattedTextField jftotalefectivo, JFormattedTextField jftotaltarjeta) {
        String sql = "select c.id_origen,to_char(c.fecha_emision,'yyyy-MM-dd HH24:MI') as fecha_emision,c.descripcion,"
                ...
                + "order by 1 desc";
        eveconn.Select_cargar_jtable(conn, sql, tabla);
        caja_detalle_cantidad_total_venta(fk_idcaja_cierre, txtcantidad, jftotalefectivo, jftotaltarjeta);
    ...
    void caja_detalle_cantidad_total_venta(String fk_idcaja_cierre,  JTextField txtcantidad,JFormattedTextField jftotalefectivo, JFormattedTextField jftotaltarjeta) {
        String titulo = "caja_detalle_cantidad_total";
        String sql = "select count(*) as cantidad,\n"
                + "sum(c.monto_venta_efectivo) as v_efectivo,"
        ...
        try {
            ...
            if (rs.next()) {
                String cantidad = rs.getString("cantidad");
                txtcantidad.setText(cantidad);
                int v_efectivo = rs.getInt("v_efectivo");
                jftotalefectivo.setValue(v_efectivo);
                int v_tarjeta = rs.getInt("v_tarjeta");
                jftotaltarjeta.setValue(v_tarjeta);
            }
        } catch (SQLException e) {
            evemen.mensaje_error(e, sql, titulo);
        }
    ...
    private void initComponents() {
        ...
        panel_ventaLayout.setHorizontalGroup(
            ...
            .addGroup(panel_ventaLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jFtotal_venta_efectivo, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(37, 37, 37)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jFtotal_venta_tarjeta, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jTabbedPane1.addTab("VENTAS", panel_venta);
