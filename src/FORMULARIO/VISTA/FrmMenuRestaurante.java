 ...
 * @author Digno
 */
public class FrmMenuRestaurante extends javax.swing.JFrame {
...
//    json_crear_cliente jsCli=new json_crear_cliente();
    ...
    private void habilitar_menu(boolean blo) {
        FrmMenuRestaurante.btncaja_detalle.setEnabled(blo);
        FrmMenuRestaurante.btncliente.setEnabled(blo);
        FrmMenuRestaurante.btngasto.setEnabled(blo);
        FrmMenuRestaurante.btnproducto.setEnabled(blo);
        FrmMenuRestaurante.btnvale.setEnabled(blo);
        FrmMenuRestaurante.btnventa.setEnabled(blo);
        FrmMenuRestaurante.btncomanda.setEnabled(blo);
        FrmMenuRestaurante.btncategoria.setEnabled(blo);
        FrmMenuRestaurante.btnbalance.setEnabled(blo);
        FrmMenuRestaurante.btncambiar_usuario.setEnabled(blo);
        FrmMenuRestaurante.jMenu_caja.setEnabled(blo);
        FrmMenuRestaurante.jMenu_cliente.setEnabled(blo);
        FrmMenuRestaurante.jMenu_config.setEnabled(blo);
        FrmMenuRestaurante.jMenu_delivery.setEnabled(blo);
        FrmMenuRestaurante.jMenu_gasto.setEnabled(blo);
        FrmMenuRestaurante.jMenu_producto.setEnabled(blo);
        FrmMenuRestaurante.jMenu_venta.setEnabled(blo);
        FrmMenuRestaurante.jMenu_fatura.setEnabled(blo);
        FrmMenuRestaurante.btncomprainsumo.setEnabled(blo);
        FrmMenuRestaurante.jMenu_compra.setEnabled(blo);
    ...
    void iniciarTiempo() {
        ...
        tiempo.schedule(new FrmMenuRestaurante.clasetimer(), 0, 1000 * 1);
...
//                + "update venta set monto_venta_tarjeta=0; "
                + "update caja_detalle set tabla_origen='VENTA_COMBINADO' where tabla_origen='VENTA_COMBI';\n"
                + "        EXCEPTION\n"
    ...
    private void initComponents() {
        ...
        jMenuItem38.setText("CUENTA");
        jMenuItem38.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem38ActionPerformed(evt);
            }
        });
        jMenu_producto.add(jMenuItem38);
        ...
        jMenuItem36.setText("CAJERO");
        jMenuItem36.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem36ActionPerformed(evt);
            }
        });
        jMenu_config.add(jMenuItem36);

        jMenuItem37.setText("EMPRESA");
        ...
        jMenuItem39.setText("TIMBRADO");
        jMenuItem39.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem39ActionPerformed(evt);
            }
        });
        jMenu_fatura.add(jMenuItem39);
...
//        evetbl.abrir_TablaJinternal(new FrmCajaDetalle());
    ...
    private void jMenuItem16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem16ActionPerformed
        // TODO add your handling code here:
        evetbl.abrir_TablaJinternal(new FrmCrearBackup1());
    ...
    private void jMenuItem38ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem38ActionPerformed
        // TODO add your handling code here:
        evetbl.abrir_TablaJinternal(new FrmProducto_cuenta());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMenuRestaurante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMenuRestaurante().setVisible(true);
            }
        });
    }
