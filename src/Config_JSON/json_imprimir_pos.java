...
public class json_imprimir_pos {
    ...
    /**
     * @param aVen_item_idv the ven_item_idv to set
     */
    public static void setVen_item_idv(int aVen_item_idv) {
        ven_item_idv = aVen_item_idv;
    }

    /**
     * @return the ven_item_cliente
     */
    ...
    /**
     * @param aVen_item_cliente the ven_item_cliente to set
     */
    public static void setVen_item_cliente(int aVen_item_cliente) {
        ven_item_cliente = aVen_item_cliente;
    }

    /**
     * @return the ven_item_monto
     */
    ...
    /**
     * @param aVen_item_monto the ven_item_monto to set
     */
    public static void setVen_item_monto(int aVen_item_monto) {
        ven_item_monto = aVen_item_monto;
    }
    ...
    public static void setPrint_insumo(boolean print_insumo) {
        json_imprimir_pos.print_insumo = print_insumo;
    }
